CREATE SEQUENCE l10_guj_sno_seq;

CREATE TABLE l10_guj
(
    sno integer NOT NULL DEFAULT nextval('l10_guj_sno_seq'::regclass),
    ...
    CONSTRAINT l10_guj_pkey PRIMARY KEY (sno)
)