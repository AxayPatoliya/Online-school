CREATE SEQUENCE l12_phy_sno_seq;

CREATE TABLE l12_phy
(
    sno integer NOT NULL DEFAULT nextval('l12_phy_sno_seq'::regclass),
    ...
    CONSTRAINT l12_phy_pkey PRIMARY KEY (sno)
)