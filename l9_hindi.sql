CREATE SEQUENCE l9_hindi_sno_seq;

CREATE TABLE l9_hindi
(
    sno integer NOT NULL DEFAULT nextval('l9_hindi_sno_seq'::regclass),
    ...
    CONSTRAINT l9_hindi_pkey PRIMARY KEY (sno)
)