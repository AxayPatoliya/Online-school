CREATE SEQUENCE l10_eng_sno_seq;

CREATE TABLE l10_eng
(
    sno integer NOT NULL DEFAULT nextval('l10_eng_sno_seq'::regclass),
    ...
    CONSTRAINT l10_eng_pkey PRIMARY KEY (sno)
)