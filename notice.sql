...
(
    ...
    title_1 text COLLATE pg_catalog."default" NOT NULL,
    content_1 text COLLATE pg_catalog."default" NOT NULL,
    title_2 text COLLATE pg_catalog."default" NOT NULL,
    content_2 text COLLATE pg_catalog."default" NOT NULL,
    title_3 text COLLATE pg_catalog."default" NOT NULL,
    content_3 text COLLATE pg_catalog."default" NOT NULL,
