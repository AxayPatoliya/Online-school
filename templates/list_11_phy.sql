CREATE SEQUENCE l11_phy_sno_seq;

CREATE TABLE l11_phy
(
    sno integer NOT NULL DEFAULT nextval('l11_phy_sno_seq'::regclass),
    ...
    CONSTRAINT l11_phy_pkey PRIMARY KEY (sno)
)
