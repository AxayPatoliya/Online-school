CREATE SEQUENCE l11_eng_sno_seq;

CREATE TABLE l11_eng
(
    sno integer NOT NULL DEFAULT nextval('l11_eng_sno_seq'::regclass),
    ...
    CONSTRAINT l11_eng_pkey PRIMARY KEY (sno)
)