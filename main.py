...
def edit(sno):
        if ('user' in session and session['user'] == params['admin_user']):
            if request.method == 'POST':
                ...
                box_title_1 = request.form.get('title_1')
                content_1 = request.form.get('content_1')
                box_title_2 = request.form.get('title_2')
                content_2 = request.form.get('content_2')
                box_title_3 = request.form.get('title_3')
                ...
                if sno == '0':
                    notice = Notice(category=category, title=box_title, content=content, title_1=box_title_1, title_2=box_title_2, title_3=box_title_3, content_1=content_1, content_2=content_2, content_3=content_3,  slug=slug, img_file=img_file, link_youtube_1=link_youtube_1, link_youtube_2=link_youtube_2, link_pdf_1=link_pdf_1, link_pdf_2=link_pdf_2, link_form_1=link_form_1, link_form_2=link_form_2, decr_youtube_2=decr_youtube_2, decr_pdf_2=decr_pdf_2, decr_form_2=decr_form_2)
                    ...
                    notice.title_1 = box_title_1
                    notice.content_1 = content_1
                    notice.title_2 = box_title_2
                    notice.content_2 = content_2
                    notice.title_3 = box_title_3
