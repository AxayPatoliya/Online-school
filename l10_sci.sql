CREATE SEQUENCE l10_sci_sno_seq;

CREATE TABLE l10_sci
(
    sno integer NOT NULL DEFAULT nextval('l10_sci_sno_seq'::regclass),
    ...
    CONSTRAINT l10_sci_pkey PRIMARY KEY (sno)
)