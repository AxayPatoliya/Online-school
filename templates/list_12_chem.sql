CREATE SEQUENCE l12_chem_sno_seq;

CREATE TABLE l12_chem
(
    sno integer NOT NULL DEFAULT nextval('l12_chem_sno_seq'::regclass),
    ...
    CONSTRAINT l12_chem_pkey PRIMARY KEY (sno)
)